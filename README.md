# url-slug [![build status](https://img.shields.io/travis/stldo/url-slug/2.3-stable)](https://travis-ci.org/stldo/url-slug) [![npm version](https://img.shields.io/npm/v/url-slug.svg)](https://www.npmjs.com/package/url-slug)
